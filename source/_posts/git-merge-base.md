...
这是本系列的第二篇 - 《Git 中的最近公共祖先》，第一篇在
[这里](https://lucifer.ren/blog/2021/02/11/git-bisect-bug/)
...
更多关于 `merge-base`的用法细节可以参
考[官方文档](https://mirrors.edge.kernel.org/pub/software/scm/git/docs/git-merge-base.html "官方文档")
...
而上一次提交的引用导致了 git 提交是一个链表结构。而 git 支持创建分支，并基于分支
...
[链接在这里](https://github.com/ingydotnet/git-subrepo/issues/140 "git merge 算法优化 issue")。
