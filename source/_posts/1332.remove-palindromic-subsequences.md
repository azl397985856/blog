---
title: 【LeetCode日记】 1332. 删除回文子序列
tags: [数据结构, 算法, LeetCode日记, Easy]
categories:
  - [数据结构, 字符串]
  - [算法, 回文]
  - [Easy]
...
LeetCode 上有很多抖机灵的题目，需要你仔细审题，否则很容易被套路。这里就有一道，我们来看下。

​<!-- more -->

原题地址：https://leetcode-cn.com/problems/remove-palindromic-subsequences/
