...
![](https://p.ipic.vip/qo31yk.jpg)
（查找插入位置）

![](https://p.ipic.vip/m9gkad.jpg)
（将其插入）
...
![](https://p.ipic.vip/1fha4b.jpg)

下沉到如图位置，还是不满足 **父节点的权值不大于儿子的权值（小顶堆）**，于是我们继续执行同样的操作。

![](https://p.ipic.vip/dzqpe5.jpg)
...
![](https://p.ipic.vip/t24pxp.jpg)
(第一次上浮，仍然不满足堆特性，继续上浮)

![](https://p.ipic.vip/aedmmf.jpg)
（满足了堆特性，上浮过程完毕）
...
![](https://p.ipic.vip/psvt6e.jpg)
（注意数组索引的对应关系）

形象点来看，我们可以可以画出如下的对应关系图：

![](https://p.ipic.vip/t17ivz.jpg)
...
![二维码](https://p.ipic.vip/gixqxp.jpg)
