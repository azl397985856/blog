...
![](https://p.ipic.vip/qtq5bn.jpg)

- 在一个 最大堆(max heap) 中, P 的 key(或 value)大于 C 的对应值。

![](https://p.ipic.vip/pz3jzw.jpg)
