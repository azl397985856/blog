...
![](https://p.ipic.vip/g7tw9r.jpg)

点开之后是这种画风：

![](https://p.ipic.vip/mv6u0g.jpg)

另外一个插件是`OctoLinker`。这个插件你可以用来方便地进行文件跳转。

![](https://p.ipic.vip/rrln12.jpg)
